...
> 面向中文长篇小说创作的开源 AI 工作台。把 AI 对话、项目文件、章节写作、上下文、写作 Skills、模型配置和审批流程放在一个清晰的工作台里。
...
织梦写作台不是单纯的提示词网页，也不只是小说编辑器。它以中文长篇小说创作为第一场景，把灵感、设定、人物、章节、正文、伏笔、风格、记忆、Skills、AI 对话、文件上下文和审批流程组织成一个可长期陪跑的写作工作台。

简单说：**打开它，你应该知道这是你的写作项目工作台；高级能力都藏在对话、项目、上下文、文件、审批和设置里，不再堆一堆看不懂的名字。**
