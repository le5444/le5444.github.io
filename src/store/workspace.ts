...
function normalizeBridgeFile(file: WorkspaceFile): WorkspaceFile {
  if (file.title !== "BRIDGE.md") return file;
  return {
    ...file,
...
export const defaultWorkspace = (): WorkspaceState => {
  ...
  const files: WorkspaceFile[] = [
    ...
    },
    {
      ...
      summary: "Personal OS 身份、偏好与权限边界。",
      updatedAt: now,
    },
    {
      id: uid(),
      ...
      summary: "Personal OS 总编排器运行法、委派规则、来源边界和上下文经济性。",
      updatedAt: now,
    },
    {
      id: uid(),
      ...
      summary: "Personal OS L1/L2 记忆索引。",
      updatedAt: now,
    },
    {
      id: uid(),
    ...
    },
    {
      ...
      summary: "Personal OS 总验收入口和仍未完成的生产级缺口。",
      updatedAt: now,
    },
    {
      id: uid(),
