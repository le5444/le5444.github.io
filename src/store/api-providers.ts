...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  {
    id: "openrouter-auto",
    label: "OpenRouter · 账号模型发现",
    provider: "openai-compatible",
    apiUrl: "https://openrouter.ai/api/v1",
    modelId: "openrouter-model-from-models",
    modelName: "OpenRouter Model from /models",
    group: "router",
    notes: "只填 OpenRouter 端点；模型 ID 以账号 /models 返回为准，可选择 openai/、anthropic/、google/ 等路由模型。",
  },
  {
  ...
  {
    id: "oneapi-local",
    label: "One API / New API · 自建聚合端点",
    provider: "openai-compatible",
    apiUrl: "http://localhost:3000/v1",
    modelId: "gateway-model-from-models",
    modelName: "自建聚合端点模型 from /models",
    group: "router",
    notes: "只填自建聚合网关端点；模型 ID 以后台渠道映射或 /models 返回为准。",
  },
  {
    id: "litellm-proxy",
    label: "LiteLLM · 自建聚合端点",
    provider: "openai-compatible",
    apiUrl: "http://localhost:4000/v1",
    modelId: "litellm-model-from-models",
    modelName: "LiteLLM Model from /models",
    group: "router",
    notes: "只填 LiteLLM 代理端点；模型 ID 以代理配置或 /models 返回为准。",
  },
  {
    id: "groq-llama",
    label: "Groq · 模型发现",
  ...
  },
  {
    ...
    modelName: "NVIDIA Model from /models",
    group: "global",
    notes: "只填 NVIDIA 兼容端点；具体模型以账号 /models 返回为准。",
  },
  {
    id: "cerebras-llama",
    label: "Cerebras · 模型发现",
