...
export type ExecutorActionKind = "search" | "run" | "advance" | "status" | "memory_event" | "memory_bootstrap" | "memory_consolidate" | "memory_status" | "memory_retrieve" | "context_pack" | "source_audit" | "source_digest" | "goal_bootstrap" | "skill_bootstrap" | "skill_route" | "skill_invoke" | "skill_crystallize" | "skill_review" | "skill_activate" | "skill_run" | "skill_status" | "scheduler_plan" | "scheduler_install" | "scheduler_uninstall" | "scheduler_status" | "worker_run" | "worker_status" | "worker_cancel" | "worker_merge_proposal" | "swarm_bootstrap" | "safety_review" | "sandbox_probe" | "sandbox_status" | "phase_audit" | "completion_audit" | "evolution_bootstrap" | "user_model_event" | "user_model_reflect" | "user_model_status" | "subagent_spawn" | "lock_acquire" | "lock_release" | "subagent_status" | "read_file" | "write_file" | "run_command" | "web_fetch" | "mcp_stdio_catalog" | "mcp_call" | "provider_catalog" | "provider_status" | "provider_probe" | "kairos_task" | "kairos_tick";
...
export const DEFAULT_EXECUTOR_BRIDGE: ExecutorBridgeManifest = {
  ...
  allowedActions: ["search", "run", "advance", "status", "memory_event", "memory_bootstrap", "memory_consolidate", "memory_status", "memory_retrieve", "context_pack", "source_audit", "source_digest", "goal_bootstrap", "skill_bootstrap", "skill_route", "skill_invoke", "skill_crystallize", "skill_review", "skill_activate", "skill_run", "skill_status", "scheduler_plan", "scheduler_install", "scheduler_uninstall", "scheduler_status", "worker_run", "worker_status", "worker_cancel", "worker_merge_proposal", "swarm_bootstrap", "safety_review", "sandbox_probe", "sandbox_status", "phase_audit", "completion_audit", "evolution_bootstrap", "user_model_event", "user_model_reflect", "user_model_status", "subagent_spawn", "lock_acquire", "lock_release", "subagent_status", "read_file", "write_file", "run_command", "web_fetch", "mcp_stdio_catalog", "mcp_call", "provider_catalog", "provider_status", "provider_probe", "kairos_task", "kairos_tick"],
  deniedActions: [],
  safety: [
    "浏览器前端不直接执行命令。",
...
function actionNeedsApproval(action: ExecutorActionKind) {
  return ["write_file", "run_command", "web_fetch", "mcp_call", "provider_probe", "kairos_task", "scheduler_install", "scheduler_uninstall", "skill_run"].includes(action);
}

const EXECUTOR_ACTIONS: ExecutorActionKind[] = ["search", "run", "advance", "status", "memory_event", "memory_bootstrap", "memory_consolidate", "memory_status", "memory_retrieve", "context_pack", "source_audit", "source_digest", "goal_bootstrap", "skill_bootstrap", "skill_route", "skill_invoke", "skill_crystallize", "skill_review", "skill_activate", "skill_run", "skill_status", "scheduler_plan", "scheduler_install", "scheduler_uninstall", "scheduler_status", "worker_run", "worker_status", "worker_cancel", "worker_merge_proposal", "swarm_bootstrap", "safety_review", "sandbox_probe", "sandbox_status", "phase_audit", "completion_audit", "evolution_bootstrap", "user_model_event", "user_model_reflect", "user_model_status", "subagent_spawn", "lock_acquire", "lock_release", "subagent_status", "read_file", "write_file", "run_command", "web_fetch", "mcp_stdio_catalog", "mcp_call", "provider_catalog", "provider_status", "provider_probe", "kairos_task", "kairos_tick"];
...
3. 所有 write_file/run_command/web_fetch/mcp_call/provider_probe 都必须进入审批草案或执行桥请求。
...
<bridge-request>
{
  "action": "search | run | advance | status | memory_event | memory_bootstrap | memory_consolidate | memory_status | memory_retrieve | context_pack | source_audit | source_digest | goal_bootstrap | skill_bootstrap | skill_route | skill_invoke | skill_crystallize | skill_review | skill_activate | skill_run | skill_status | scheduler_plan | scheduler_install | scheduler_uninstall | scheduler_status | worker_run | worker_status | worker_cancel | worker_merge_proposal | swarm_bootstrap | safety_review | sandbox_probe | sandbox_status | phase_audit | completion_audit | evolution_bootstrap | user_model_event | user_model_reflect | user_model_status | subagent_spawn | lock_acquire | lock_release | subagent_status | read_file | write_file | run_command | web_fetch | mcp_stdio_catalog | mcp_call | provider_catalog | provider_status | provider_probe | kairos_task | kairos_tick",
  "purpose": "为什么需要调用",
  "payload": {}
}
</bridge-request>`;
