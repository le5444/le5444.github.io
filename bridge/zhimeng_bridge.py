...
PROVIDER_PRESETS = [
    ...
    {"id": "siliconflow-deepseek-v3", "label": "硅基流动 · DeepSeek 模型发现", "provider": "openai-compatible", "api_url": "https://api.siliconflow.cn/v1", "model_id": "siliconflow-deepseek-from-models", "model_name": "DeepSeek via SiliconFlow /models", "group": "china", "notes": "只填硅基流动端点；DeepSeek 具体模型以你的账号 /models 返回为准。"},
    {"id": "tongyi-qwen-max", "label": "阿里通义 · 主端点模板", "provider": "openai-compatible", "api_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model_id": "dashscope-qwen-from-models", "model_name": "通义账号模型 from /models", "group": "china", "notes": "只填通义兼容端点；具体 qwen 模型以控制台或 /models 返回为准。"},
    {"id": "tongyi-qwen-plus", "label": "阿里通义 · 备用端点模板", "provider": "openai-compatible", "api_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model_id": "dashscope-qwen-from-models", "model_name": "通义账号模型 from /models", "group": "china", "notes": "只填通义兼容端点；具体 qwen 模型以控制台或 /models 返回为准。"},
    ...
    {"id": "zhipu-glm-4-plus", "label": "智谱 · 模型发现", "provider": "openai-compatible", "api_url": "https://open.bigmodel.cn/api/paas/v4", "model_id": "zhipu-model-from-models", "model_name": "智谱账号模型 from /models", "group": "china", "notes": "只填智谱端点；具体模型以控制台或 /models 返回为准。"},
    {"id": "zhipu-glm-4-flash", "label": "智谱 · 备用端点模板", "provider": "openai-compatible", "api_url": "https://open.bigmodel.cn/api/paas/v4", "model_id": "zhipu-model-from-models", "model_name": "智谱账号模型 from /models", "group": "china", "notes": "只填智谱端点；具体模型以控制台或 /models 返回为准。"},
    ...
    {"id": "openrouter-auto", "label": "OpenRouter · 账号模型发现", "provider": "openai-compatible", "api_url": "https://openrouter.ai/api/v1", "model_id": "openrouter-model-from-models", "model_name": "OpenRouter Model from /models", "group": "router", "notes": "只填 OpenRouter 端点；模型 ID 以账号 /models 返回为准，可选择 openai/、anthropic/、google/ 等路由模型。"},
    ...
    {"id": "oneapi-local", "label": "One API / New API · 自建聚合端点", "provider": "openai-compatible", "api_url": "http://localhost:3000/v1", "model_id": "gateway-model-from-models", "model_name": "自建聚合端点模型 from /models", "group": "router", "notes": "只填自建聚合网关端点；模型 ID 以后台渠道映射或 /models 返回为准。"},
    {"id": "litellm-proxy", "label": "LiteLLM · 自建聚合端点", "provider": "openai-compatible", "api_url": "http://localhost:4000/v1", "model_id": "litellm-model-from-models", "model_name": "LiteLLM Model from /models", "group": "router", "notes": "只填 LiteLLM 代理端点；模型 ID 以代理配置或 /models 返回为准。"},
    ...
    {"id": "nvidia-nim", "label": "NVIDIA · 模型发现", "provider": "openai-compatible", "api_url": "https://integrate.api.nvidia.com/v1", "model_id": "nvidia-model-from-models", "model_name": "NVIDIA Model from /models", "group": "global", "notes": "只填 NVIDIA 兼容端点；具体模型以账号 /models 返回为准。"},
