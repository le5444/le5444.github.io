...
PROVIDER_PRESETS = [
    {"id": "openai-gpt-4o-mini", "label": "OpenAI · gpt-4o-mini", "provider": "openai-compatible", "api_url": "https://api.openai.com/v1", "model_id": "gpt-4o-mini", "model_name": "OpenAI GPT-4o mini", "group": "official"},
    {"id": "openai-gpt-4o", "label": "OpenAI · gpt-4o", "provider": "openai-compatible", "api_url": "https://api.openai.com/v1", "model_id": "gpt-4o", "model_name": "OpenAI GPT-4o", "group": "official"},
    {"id": "deepseek-chat", "label": "DeepSeek · chat", "provider": "openai-compatible", "api_url": "https://api.deepseek.com/v1", "model_id": "deepseek-chat", "model_name": "DeepSeek Chat", "group": "china", "notes": "性价比首选，中文网文友好"},
    {"id": "deepseek-reasoner", "label": "DeepSeek · reasoner", "provider": "openai-compatible", "api_url": "https://api.deepseek.com/v1", "model_id": "deepseek-reasoner", "model_name": "DeepSeek R1", "group": "china", "notes": "推理强，适合做大纲和拆书"},
    {"id": "siliconflow-qwen", "label": "硅基流动 · Qwen2.5-72B", "provider": "openai-compatible", "api_url": "https://api.siliconflow.cn/v1", "model_id": "Qwen/Qwen2.5-72B-Instruct", "model_name": "Qwen2.5 72B (SiliconFlow)", "group": "china"},
    {"id": "siliconflow-deepseek-v3", "label": "硅基流动 · DeepSeek V3", "provider": "openai-compatible", "api_url": "https://api.siliconflow.cn/v1", "model_id": "deepseek-ai/DeepSeek-V3", "model_name": "DeepSeek V3 (SiliconFlow)", "group": "china"},
    {"id": "tongyi-qwen-max", "label": "阿里通义 · qwen-max", "provider": "openai-compatible", "api_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model_id": "qwen-max", "model_name": "通义千问 Max", "group": "china"},
    {"id": "tongyi-qwen-plus", "label": "阿里通义 · qwen-plus", "provider": "openai-compatible", "api_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model_id": "qwen-plus", "model_name": "通义千问 Plus", "group": "china"},
    {"id": "moonshot-kimi-128k", "label": "月之暗面 · Kimi 128K", "provider": "openai-compatible", "api_url": "https://api.moonshot.cn/v1", "model_id": "moonshot-v1-128k", "model_name": "Kimi Moonshot 128K", "group": "china", "notes": "长上下文友好，模型 ID 以控制台为准"},
    {"id": "zhipu-glm-4-plus", "label": "智谱 · GLM-4 Plus", "provider": "openai-compatible", "api_url": "https://open.bigmodel.cn/api/paas/v4", "model_id": "glm-4-plus", "model_name": "智谱 GLM-4 Plus", "group": "china"},
    {"id": "zhipu-glm-4-flash", "label": "智谱 · GLM-4 Flash", "provider": "openai-compatible", "api_url": "https://open.bigmodel.cn/api/paas/v4", "model_id": "glm-4-flash", "model_name": "智谱 GLM-4 Flash", "group": "china"},
    {"id": "baichuan4", "label": "百川 · Baichuan4", "provider": "openai-compatible", "api_url": "https://api.baichuan-ai.com/v1", "model_id": "Baichuan4", "model_name": "百川 Baichuan4", "group": "china"},
    {"id": "stepfun-step-2", "label": "阶跃星辰 · step-2", "provider": "openai-compatible", "api_url": "https://api.stepfun.com/v1", "model_id": "step-2-16k", "model_name": "StepFun step-2", "group": "china", "notes": "模型 ID 以控制台为准"},
    {"id": "minimax-abab", "label": "MiniMax · abab", "provider": "openai-compatible", "api_url": "https://api.minimax.chat/v1", "model_id": "abab6.5s-chat", "model_name": "MiniMax abab", "group": "china", "notes": "模型 ID 以控制台为准"},
    {"id": "yi-large", "label": "零一万物 · yi-large", "provider": "openai-compatible", "api_url": "https://api.lingyiwanwu.com/v1", "model_id": "yi-large", "model_name": "Yi Large", "group": "china"},
    {"id": "volcengine-doubao", "label": "火山方舟 · Doubao", "provider": "openai-compatible", "api_url": "https://ark.cn-beijing.volces.com/api/v3", "model_id": "doubao-seed-1-6", "model_name": "火山方舟 Doubao", "group": "china", "notes": "很多方舟模型需要填控制台 endpoint/model ID"},
    {"id": "tencent-hunyuan", "label": "腾讯混元 · hunyuan", "provider": "openai-compatible", "api_url": "https://api.hunyuan.cloud.tencent.com/v1", "model_id": "hunyuan-turbo", "model_name": "腾讯混元 Turbo", "group": "china", "notes": "模型 ID 以控制台为准"},
    {"id": "claude-sonnet-4-6", "label": "Claude Sonnet 4.6 (官方)", "provider": "anthropic", "api_url": "https://api.anthropic.com/v1", "model_id": "claude-sonnet-4-6", "model_name": "Claude Sonnet 4.6", "group": "official", "notes": "长篇一致性强"},
    {"id": "claude-opus-4-7", "label": "Claude Opus 4.7 (官方)", "provider": "anthropic", "api_url": "https://api.anthropic.com/v1", "model_id": "claude-opus-4-7", "model_name": "Claude Opus 4.7", "group": "official", "notes": "最强写作力"},
    {"id": "gemini-2.0-flash", "label": "Gemini 2.0 Flash", "provider": "gemini", "api_url": "https://generativelanguage.googleapis.com/v1beta", "model_id": "gemini-2.0-flash", "model_name": "Gemini 2.0 Flash", "group": "official"},
    {"id": "gemini-1.5-pro", "label": "Gemini 1.5 Pro (长上下文)", "provider": "gemini", "api_url": "https://generativelanguage.googleapis.com/v1beta", "model_id": "gemini-1.5-pro", "model_name": "Gemini 1.5 Pro", "group": "official"},
    ...
    {"id": "mistral-large", "label": "Mistral · large", "provider": "openai-compatible", "api_url": "https://api.mistral.ai/v1", "model_id": "mistral-large-latest", "model_name": "Mistral Large", "group": "global"},
    {"id": "perplexity-sonar", "label": "Perplexity · sonar", "provider": "openai-compatible", "api_url": "https://api.perplexity.ai", "model_id": "sonar-pro", "model_name": "Perplexity Sonar Pro", "group": "global"},
    {"id": "xai-grok", "label": "xAI · Grok", "provider": "openai-compatible", "api_url": "https://api.x.ai/v1", "model_id": "grok-2-latest", "model_name": "xAI Grok", "group": "global", "notes": "模型 ID 以账号可用列表为准"},
    {"id": "together-llama", "label": "Together · Llama", "provider": "openai-compatible", "api_url": "https://api.together.xyz/v1", "model_id": "meta-llama/Llama-3.3-70B-Instruct-Turbo", "model_name": "Together Llama 70B", "group": "global"},
    {"id": "fireworks-llama", "label": "Fireworks · Llama", "provider": "openai-compatible", "api_url": "https://api.fireworks.ai/inference/v1", "model_id": "accounts/fireworks/models/llama-v3p1-70b-instruct", "model_name": "Fireworks Llama", "group": "global"},
    {"id": "nvidia-nim", "label": "NVIDIA NIM", "provider": "openai-compatible", "api_url": "https://integrate.api.nvidia.com/v1", "model_id": "meta/llama-3.1-70b-instruct", "model_name": "NVIDIA NIM", "group": "global"},
    {"id": "cerebras-llama", "label": "Cerebras · Llama", "provider": "openai-compatible", "api_url": "https://api.cerebras.ai/v1", "model_id": "llama-3.3-70b", "model_name": "Cerebras Llama", "group": "global"},
    {"id": "ollama-qwen", "label": "Ollama · qwen2.5", "provider": "ollama", "api_url": "http://localhost:11434", "model_id": "qwen2.5:14b", "model_name": "Ollama Qwen2.5 14B", "group": "local", "notes": "本地，不需密钥"},
    {"id": "lmstudio-local", "label": "LM Studio (本地)", "provider": "openai-compatible", "api_url": "http://localhost:1234/v1", "model_id": "local-model", "model_name": "LM Studio Local", "group": "local", "notes": "本地，密钥可填任意值"},
    {"id": "vllm-local", "label": "vLLM / llama.cpp server", "provider": "openai-compatible", "api_url": "http://localhost:8000/v1", "model_id": "local-model", "model_name": "Local OpenAI-compatible Server", "group": "local", "notes": "适合 vLLM、llama.cpp、FastChat 等 OpenAI-compatible 服务"},
]
